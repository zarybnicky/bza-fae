...
buildTXData txName = 
  ...
  where err = die . errorBundlePretty
...
specFile = runPermutation $
  (\mainModule otherModules -> TXData LoadedModules{..})
  <$> toPermutation (noIndent body)
  <*> toPermutationWithDefault Map.empty (noIndent others)
  <*> toPermutationWithDefault [] (noIndent fallback)
  <*> toPermutationWithDefault[] (noIndent materials)
  <*> toPermutationWithDefault [] (noIndent inputs)
  <*> toPermutationWithDefault [] (noIndent keys)
  <*> toPermutationWithDefault False (noIndent reward)
  <*> toPermutationWithDefault Nothing (Just <$> noIndent parent)
